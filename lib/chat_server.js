...
// shared
let nickNames = {}; // <socket.id, name>
let namesUsed = []; // name
let currentRoom = {}; // <socket.id, room>
let guestNumber = 1;
let io = null;
...
function assignGuestName(socket, guestNumber, nickNames, namesUsed) {
    ...
    * 如果有新的连接过来，分配一个原始编号名
    * */
    let name = constants.initial_name_prefix + guestNumber;
...
function joinRoom(socket, room) {
    ...
    let usersInRoomSummary = generateUsersInRoomSummaryStr();
